...
#.....ULTIMA PREGUNTA..#
                if Respuesta4 == "Mark Zuckerberg" or Respuesta4 == "mark zuckerberg" or Respuesta4 == "zuckerberg" or Respuesta4 == "Mark" or Respuesta4 == "MARK ZUCKERBERG" or Respuesta4 == "mark" or Respuesta4 == "MARK":
                    print(Fore.GREEN + f'''
    ...
    Eres Mas Gei Non Dijiste Sis o Non :rage:
                            ''')
                    elif Bonus_1 == "End" or "end" or "END":
                        print(Fore.RED + '''
